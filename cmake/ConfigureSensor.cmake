...
SET(SENSOR_LIBREALSENSE2 0 CACHE BOOL "Use Intel LibRealSense2")
#SET(SENSOR_OPENNI 0 CACHE BOOL "Use PrimeSense Carmine or ASUS Xtion with OpenNI")

SET(SENSOR "librealsense2" CACHE STRING "Define your own sensor while configuring CMAKE")
SET(SENSOR_LIST depthsensegrabber librealsense librealsense2 openni realsense softkin)
...
if (SENSOR STREQUAL "librealsense2")
    set (SENSOR_TEST LIBREALSENSE2)
    if (SENSOR_COUNT EQUAL 0)
        set(SENSOR_COUNT 1)
        set(SENSOR_TYPE ${SENSOR_TEST})
        message(STATUS "Enabling ${SENSOR_TEST}")
...
endif (SENSOR STREQUAL "librealsense2")
