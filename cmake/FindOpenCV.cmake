...
message(STATUS "OpenCV2_ROOT: ${OpenCV_ROOT_INC_DIR}")


set(OpenCV2_CORE_INCLUDE_DIR "${OpenCV_ROOT_INC_DIR}/opencv2/core")
set(OpenCV2_IMGPROC_INCLUDE_DIR "${OpenCV_ROOT_INC_DIR}/opencv2/imgproc")
set(OpenCV2_IMGCODECS_INCLUDE_DIR "${OpenCV_ROOT_INC_DIR}/opencv2/imgcodecs")
set(OpenCV2_HIGHGUI_INCLUDE_DIR "${OpenCV_ROOT_INC_DIR}/opencv2/highgui")
set(OpenCV2_FLANN_INCLUDE_DIR "${OpenCV_ROOT_INC_DIR}/opencv2/flann")
...
#list(APPEND OPENCV2_LIBRARY_SEARCH_PATHS "/opt/conda/lib")


#--- FIND RELEASE LIBRARIES
set(OpenCV2_CORE_LIBRARY_REL "${OPENCV2_LIBRARY_SEARCH_PATHS}/libopencv_core.so")
set(OpenCV2_IMGPROC_LIBRARY_REL "${OPENCV2_LIBRARY_SEARCH_PATHS}/libopencv_imgproc.so")
set(OpenCV2_IMGCODECS_LIBRARY_REL "${OPENCV2_LIBRARY_SEARCH_PATHS}/libopencv_imgcodecs.so")
set(OpenCV2_HIGHGUI_LIBRARY_REL "${OPENCV2_LIBRARY_SEARCH_PATHS}/libopencv_highgui.so")
